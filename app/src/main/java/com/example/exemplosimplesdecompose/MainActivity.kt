...
import com.example.exemplosimplesdecompose.view.GasStationDetail
            ...
            ExemploSimplesDeComposeTheme {
                ...
                NavHost(navController = navController, startDestination = "welcome") {
                   ...
                   // composable("input") { InputView(navController) }
                    ...
                    composable("listaDePostos") { backStackEntry ->
                        ListofGasStations(navController)
                    }
                    composable("detalhesPosto/{stationName}") { backStackEntry ->
                        val name = backStackEntry.arguments?.getString("stationName") ?: ""
                        GasStationDetail(navController, name)
                    }
